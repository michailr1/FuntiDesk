...
Структура подлежит подтверждению архитектором. Находки ревью, на которых основано
это описание: `docs/UPSTREAM_REVIEW.md`.
...
Найденные при ревью конкретные точки расхождения с указанием файлов перечислены
в `docs/UPSTREAM_REVIEW.md`.
